...
public class MeshDestroy : MonoBehaviour
{
    ...
    public bool hit;
    public AudioSource hammerSoundPlayer;
    public AudioSource rockSoundPlayer;
    public AudioSource evaporateSoundPlayer;
    ...
    {   
        ...
        {
            if(hammerSoundPlayer)
                hammerSoundPlayer.Play();
            if(rockSoundPlayer)
                 rockSoundPlayer.Play();
            DestroyMesh();
        }
    ...
    private void DestroyMesh()
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            ...
            if(evaporateSoundPlayer)
             evaporateSoundPlayer.Play();
        }
