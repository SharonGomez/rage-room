...
public class ceramics : MonoBehaviour
{
   ...
   // private bool hit=true;
    ...
    {   
       ...
       {
        collision.gameObject.tag = "deweaponise";
        audioplayer.Play();
         DestroyMesh();
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(ceramics original)
        {
            ...
            var ceramics = GameObject.AddComponent<ceramics>();
            ceramics.CutCascades = original.CutCascades;
            ceramics.ExplodeForce = original.ExplodeForce;
